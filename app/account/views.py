...
from .forms import (ChangeEmailForm, ChangePasswordForm, CreatePasswordForm,
                    ...
                    ResetPasswordForm, CancelReservationForm)
import sys
...
def manage():
    ...
    return render_template('account/manage.html', user=current_user, space_reservations=space_reservations, equipment_reservations=equipment_reservations, cancel_reservation_form=cancel_reservation_form)
